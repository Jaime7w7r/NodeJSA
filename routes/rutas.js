...
/*router.get('/', (req, res) => {
    res.send({
        message: "hola mundo soy Jaime Adolfo Varela Martínez"
    });
});*/
router.get('/ayuda', (req, res) => {
    res.send({
        message: "En que te ayudo soy Jaime Adolfo Varela Martínez"
    });
});
router.get('/ayuda/:name', (req, res) => {
    res.send({
        message: `Hola ${req.params.name} en que te ayudo`
    });
});
router.get('/prueba', (req, res) => {
    res.send({
        message: `Hola ${req.query.name} ${req.query.apellido}`
    });
});
//Practica 2
